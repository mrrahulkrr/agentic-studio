# ---------------------------------------------------------------------------
# Developer docs registry
#
# Two security properties this module is designed to preserve:
#   1. No user-supplied value is ever joined onto a filesystem path — the
#      {key} from GET /admin/docs/{key} is only used as a dict key into
...
# backend/ is this repo's declared working directory (see README.md), but
