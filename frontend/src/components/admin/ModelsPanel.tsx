...
// approved alternatives. Read-only by design — changing a tier's default
// means setting its FAST_MODEL/STANDARD_MODEL/QUALITY_MODEL env var and
// redeploying (see README.md), not a control here.
"use client";
