...
export const TIER_CANDIDATES: Record<ModelTier, TierCandidate[]> = {
  FAST: [
    ...
    },
    {
      ...
      description:
        "Empirically verified fast fallback model — high throughput and low latency for quick checks.",
    },
  ],
  STANDARD: [
    {
    ...
    },
    {
      ...
      description:
        "Verified active alternative, highly efficient at planning multi-step content with sharp write-ups.",
    },
  ],
  QUALITY: [
    {
      ...
      description:
        "The most capable option available — best for the one decision in a run you most want to trust, like the final greenlight verdict.",
    },
    {
      model: "gemini-3.5-flash",
      description:
        "Highly reliable, verified mid-tier fallback with 100% API availability for complex evaluations.",
    },
  ],
};
